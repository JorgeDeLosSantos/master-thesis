...
\begin{center}
\includegraphics[width=0.9\textwidth]{src/ch3/diagrama_metodologia.pdf}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{src/ch3/metodologia_analisis_fem.pdf}
...
Para fabricar el tubo interior \ref{fig:ti_rb131} se utiliza un troquel compuesto o semi-progresivo 
...
\includegraphics[width=\textwidth]{src/ch3/mesh_blank.png}
\caption{}
\label{fig:mesh_blank}
\end{subfigure}
~ 
\begin{subfigure}[t]{0.4\textwidth}
\includegraphics[width=\textwidth]{src/ch3/mesh_blank_front.png}
\caption{}
\label{fig:mesh_blank_front}
\end{subfigure}

\caption{Mallado del blank en vista a) trimétrica b) frontal}
\end{figure}
...
\begin{figure}[!h]
\centering
\includegraphics[scale=0.5]{src/ch3/parts_plot.png}
