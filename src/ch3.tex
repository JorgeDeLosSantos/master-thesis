...
El análisis por elementos finitos en problemas de ingeniería es un proceso iterativo, 
en el que normalmente hay que ajustar algunos parámetros e ir revisando que los 
resultados obtenidos sean, al menos en principio, coherentes o se encuentren dentro 
de un rango esperado. \\
...
De manera generalizada, el método de los elementos finitos implica transformar un fenómeno 
físico en un sistema de ecuaciones diferenciales que incluyen consideraciones sobre la geometría, 
cinemática, modelo constitutivo, condiciones de carga, entre otros, del fenómeno analizado.
No obstante, cuando se utiliza un software de simulación, estos normalmente incorporan un entorno integrado que 
proporciona y facilita el desarrollo de un modelo de elementos finitos a partir 
de las geometrías involucradas, las propiedades del material y las condiciones de carga, 
debido a esto, el proceso para el análisis por elementos finitos involucra, al menos, 
los puntos que se muestran en el diagrama de la figura \ref{fig:metodologia_analisis_fem}. 

\begin{center}
\includegraphics[width=0.65\textwidth]{src/ch3/metodologia_analisis_fem.pdf}
\captionof{figure}{Metodología para el análisis por elementos finitos explícito}
...
(\textit{blank}) rectangular de acero AISI 1018, con un largo de 3 pulgadas y un ancho de 2.125 pulgadas, 
con un espesor de 0.12 pulgadas (ver figura \ref{fig:blank_inicial}). La placa metálica tiene además 
...
\captionof{figure}{Malla del \textit{blank}}
...
\captionof{figure}{Malla del formador inferior}
...
\end{subfigure}
\caption{Malla de a) formador superior izquierdo b) formador superior derecho}
\end{figure}
...
\end{subfigure}
\caption{Malla de a) leva izquierdo b) leva derecha}
\end{figure}
...
\caption{Malla del formador inferior}
\label{fig:mesh_fi}
\end{figure}
...
\caption{Malla del formador superior}
\label{fig:mesh_fi}
\end{figure}
...
% \caption{Malla de a) formador inferior b) formador superior c) leva}
% \end{figure}
...
la malla deformada del blank. El Malla de cada uno de los componentes del troquel 
...
% \caption{Malla del segundo ensamble}
% \label{fig:parts_02}
% \end{figure}
...
\caption{Malla del formador final inferior}
\label{fig:mesh_ffi}
\end{figure}
...
\caption{Malla del formador final superior}
\label{fig:mesh_ffs}
\end{figure}
...
\caption{Malla del perno formador}
...
\captionof{figure}{Esquema de la conexión de medio puente realizada (vista superior del \textit{blank})}
