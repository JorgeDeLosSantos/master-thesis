...
herramental, $\alpha_f$ el ángulo deseado en la pieza de trabajo (después de la recuperación elástica), 
...
von Mises, la diferenciación resulta en:
...
relación de las deformaciones plásticas permanece constante:\\
...
|\tau| = 1 \,\,\, \text{implica que} \,\,\, \text{sgn}(\dot{u}) = \text{sgn}(\tau)
\end{matrix}
\right.
\end{equation}
