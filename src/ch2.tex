...
\begin{figure}[!h]
\centering
\includegraphics[scale=0.75]{src/ch2/strain_gauge_scheme.png}
...
\begin{figure}[!h]
\centering
\includegraphics[scale=0.65]{src/ch2/wheatstone_bridge.png}
...
función de la deformación (ver figura \ref{fig:quarter_bridge}). Note la presencia 
...
\begin{figure}[!h]
\centering
\includegraphics[scale=1.0]{src/ch2/quarter_bridge.png}
