...
El factor de galga para galgas extensiométricas es típicamente alrededor de 2.	\\
...
de las deformaciones requiere una medición precisa de pequeñas variaciones en la resistencia.\\
...
aplicado a través del puente.

\begin{figure}[!h]
\centering
\includegraphics[scale=0.55]{src/ch2/wheatstone_bridge.png}
...
cualquiera de las ramificaciones del puente resultará en un voltaje de salida diferente de cero.\\
...
la salida del cuarto de puente con respecto a la deformación.
...
y los efectos de los cambios por temperatura son minimizados.
...
ramificaciones del puente sean galgas activas.
